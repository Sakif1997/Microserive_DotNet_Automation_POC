...
public class TradePage extends Methods{
    ...
    public void TradeForm(String branchcode, String productcode, String accountnumber, String customercode, String customerlinkaccount, String lcamount, String createdby) throws InterruptedException{
        ...
        FieldValue(CustomerCode, customercode);
